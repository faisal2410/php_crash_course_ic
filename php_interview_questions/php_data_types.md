...
// Question 3: Which PHP data type can hold multiple values ?
...
// Question 4: In PHP, a boolean data type can hold one of two values: ______ or ______.
...
// Question 5: The ______ data type in PHP is used to store a number with a decimal point.
...
// Question 6: An array in PHP is a type of ______ data type.
...
// Question 7: PHP supports eight primitive data types.
...
// Question 8: In PHP, a string can contain letters, numbers, and special characters.
...
// Question 9: In PHP, an array can only hold values of the same data type.
...
// Question 10: Which of the following are valid data types in PHP ?
...
// Question 11: Which of the following PHP data types can hold multiple values?
// Explanation
...
// Question 12: Which of the following are true about PHP data types ?
...
// Question 13: You need to store a user's age in your PHP script. What data type would you use and why?
...
// Question 14: You have a variable in your PHP script that needs to hold a simple true or false value.What data type would you use ?
...
// Question 15: Which PHP function is used to check if a variable is of a specified type ?
...
// Question 16: You have a PHP script and you need to check if a variable is of a specified type.How would you do this ?
